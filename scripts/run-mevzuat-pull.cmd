@echo off
REM Gecelik mevzuat cekimi (Faz 2 veri): yonetmelik + CB yonetmeligi + tebligler + CB karari.
...
.venv\Scripts\python.exe -X utf8 scripts\mevzuat_pull.py --tur YONETMELIK --tur CB_YONETMELIK --tur TEBLIGLER --tur CB_KARAR --sleep 0.5 >> "%LOG%" 2>&1
set RC=%errorlevel%
